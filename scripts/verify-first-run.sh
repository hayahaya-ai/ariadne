...
expect_contains "$verdict_json" '"schema_version": "ariadne.verdict/v2"'
...
expect_contains "$assess_summary" "Evidence files: .claude/settings.json; .codex/config.toml; mcp.json; .env"
...
expect_contains "$llm_request_summary" "Ingestible as analyst output: yes"
expect_contains "$llm_request_summary" "Evidence available:"
expect_contains "$llm_request_summary" "Reviewer tasks:"
expect_contains "$llm_request_summary" "explain_reckless_findings"
...
expect_contains "$assess_txt" "Evidence files: .claude/settings.json; .codex/config.toml; mcp.json; .env"
...
expect_contains "$assess_txt" "Artifact: closure-receipt.txt"
...
expect_contains "$assess_txt" "closure-receipt.txt"
...
expect_contains "$assess_html" "Compare artifact: closure-receipt.txt"
...
expect_contains "$assess_html" "closure-receipt.txt"
...
expect_contains "$dashboard_html" "Action Packet"
expect_contains "$dashboard_html" "Open first evidence"
expect_contains "$dashboard_html" "Action commands"
expect_contains "$dashboard_html" "Suggested destination"
expect_contains "$dashboard_html" "Destination path"
expect_contains "$dashboard_html" "Done criteria"
...
expect_contains "$cases_txt" "Evidence files: .claude/settings.json; .codex/config.toml; .env; mcp.json"
...
expect_contains "$cases_action" "Ariadne Case Action"
expect_contains "$cases_action" "Focus: case:input-trust-boundary"
expect_contains "$cases_action" "Case: Input Trust Boundary (case:input-trust-boundary)"
expect_contains "$cases_action" "Current proof target:"
expect_contains "$cases_action" "Open first:"
expect_contains "$cases_action" "Action commands:"
expect_contains "$cases_action" "Export proof files"
expect_contains "$cases_action" "--patch-dir proof-patches"
expect_contains "$cases_action" "Create closure receipt"
...
expect_contains "$closure_dir/README.md" "closure-receipt.txt"
...
expect_contains "$self_bundle/README.md" "ariadne compare --before before-proof.json --after after-proof.json --format receipt --out closure-receipt.txt"
...
expect_contains "$self_bundle/llm-follow-up-request.txt" "Ingestible as analyst output: yes"
...
expect_contains "$self_bundle/llm-follow-up-request.txt" "explain_reckless_findings"
...
expect_contains "$self_bundle/llm-inventory-blind-request.txt" "Ingestible as analyst output: no; request-only"
...
expect_contains "$self_bundle/dashboard.html" "Compare artifact: closure-receipt.txt"
...
expect_contains "$self_bundle/dashboard.html" "Action Packet"
expect_contains "$self_bundle/dashboard.html" "Open first evidence"
expect_contains "$self_bundle/dashboard.html" "Action commands"
expect_contains "$self_bundle/dashboard.html" "Suggested destination"
expect_contains "$self_bundle/dashboard.html" "Destination path"
expect_contains "$self_bundle/dashboard.html" "Done criteria"
...
expect_contains "$endpoint_action" "Artifact: closure-receipt.txt"
...
expect_contains "$endpoint_action" "closure-receipt.txt"
...
expect_contains "$endpoint_html" "Compare artifact: closure-receipt.txt"
...
expect_contains "$endpoint_html" "Action Packet"
expect_contains "$endpoint_html" "Open first evidence"
expect_contains "$endpoint_html" "Action commands"
expect_contains "$endpoint_html" "Suggested destination"
expect_contains "$endpoint_html" "Destination path"
expect_contains "$endpoint_html" "Done criteria"

...
func Registry() []Rule {
	return []Rule{
		...
		{Runtime: "codex", Scope: "repo", Category: "command-hook", Kind: "codex-hooks", HandlingMode: "parse", Summary: "Codex lifecycle hooks can enforce policy before shell tool execution.", Matches: exact(".codex/hooks.json")},

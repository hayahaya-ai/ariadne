...
func TestSchemaFilesCoverArchitectureContracts(t *testing.T) {
	...
	assertRequiredKeys(t, assessOperatorWorkbench, "available", "case", "signal_chain", "evidence_to_open", "graph_path", "proof", "proof_state", "verify", "closure_loop", "actions", "done_criteria", "change_readout", "limitations")

...
- Emits focused architecture JSON for single targets and fleets, including boundary coverage, evidence anchors, missing evidence, next collectors, and a ranked closure plan for missing hard barriers.

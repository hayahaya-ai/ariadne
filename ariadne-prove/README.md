...
| `ariadne proofs --path <dir> --case <case-id>` | Show the focused proof patches, evidence refs, rerun commands, compare-loop commands, and success criteria for one closure case. |

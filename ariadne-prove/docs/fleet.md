...
5. Track Zero Trust closure by querying `closure_families[]`, `closure_plan[]`, `boundary_coverage[].missing_evidence`, `boundary_coverage[].next_collectors`, and `boundary_coverage[].control_evidence_needed`.

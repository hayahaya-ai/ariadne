...
- `first_action`, the highest-priority case distilled into one fact-backed action with priority reason, next step, evidence refs, proof surfaces, rerun commands, compare commands, and success criteria

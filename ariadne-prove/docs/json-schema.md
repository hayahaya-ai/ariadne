...
- `operator_cases`, where each architecture break-path workstream becomes an actionable case with evidence references, starting controls, proof surfaces, evidence examples, rerun commands, and success criteria
